...
import { FournisseurForm } from '@/components/rapprochement/fournisseurs/fournisseur-form'
import { fournisseurs as mockFournisseurs } from '@/lib/rapprochement-mock-data'
...
export default function FournisseursPage() {
  ...
  const filteredFournisseurs = fournisseurs.filter(
    (f) => f.statut === 'Actif' && (f.raisonSociale.toLowerCase().includes(searchTerm.toLowerCase()) || f.emailFacturation?.toLowerCase().includes(searchTerm.toLowerCase()))
  )
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={openDialog} onOpenChange={setOpenDialog}>
          ...
          <DialogContent>
            ...
            <FournisseurForm fournisseur={editingFournisseur} onSave={handleSave} onCancel={() => { setOpenDialog(false); setEditingId(null); }} />
          </DialogContent>
        </Dialog>
      </div>

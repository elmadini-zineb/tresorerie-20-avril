...
import { fournisseurs as initialFournisseurs } from '@/lib/rapprochement-mock-data'
import type { Fournisseur } from '@/lib/rapprochement-types'
import { getStatusColor } from '@/lib/rapprochement-format'
...
export default function FournisseursPage() {
  ...
  const filteredFournisseurs = fournisseurs.filter(
    (f) =>
      ...
      (f.ice && f.ice.includes(searchQuery)) ||
              ...
              {filteredFournisseurs.length === 0 ? (
                ...
                paginatedFournisseurs.map((fournisseur) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge className={getStatusColor(fournisseur.statut ?? 'Inactif')}>
                        {fournisseur.statut}
                      </Badge>
                    </TableCell>
                    <TableCell>

...
import { invoices as initialInvoices } from '@/lib/rapprochement-mock-data'
import type { Invoice, InvoiceType } from '@/lib/rapprochement-types'
import { formatAmount, formatDate, getStatusColor, getStatusLabel, getSourceColor } from '@/lib/rapprochement-format'
import { InvoiceForm } from '@/components/rapprochement/factures/invoice-form'
                    ...
                    {filteredInvoices.length === 0 ? (
                      ...
                      paginatedInvoices.map((invoice) => (
                        ...
                        >
                          ...
                          <TableCell className="text-[#64748B]">
                            {invoice.dateEcheance ? formatDate(invoice.dateEcheance) : 'N/A'}
                          </TableCell>

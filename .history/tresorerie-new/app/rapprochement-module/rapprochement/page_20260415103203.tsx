...
import { reconciliations, additionalReconciliations, fournisseurs, clients } from '@/lib/rapprochement-mock-data'
import type { Reconciliation } from '@/lib/rapprochement-types'
import { formatAmount, formatDate, getScoreColor, getScoreBgClass } from '@/lib/rapprochement-format'
...
function ReconciliationCard({
  ...
  if (!status) {
    // Gère le cas où le statut n'est pas trouvé, pour éviter un crash.
    console.warn(`Statut de rapprochement inconnu rencontré : ${reco.status}`);
    return null; // Ne rend pas cette carte si le statut est invalide.
  }

...
import { clients as initialClients } from '@/lib/rapprochement-mock-data'
import type { Client } from '@/lib/rapprochement-types'
import { getStatusColor } from '@/lib/rapprochement-format'
import { ClientForm } from '@/components/rapprochement/clients/client-form'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
              ...
              {filteredClients.length === 0 ? (
                ...
                paginatedClients.map((client) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge className={getStatusColor(client.statut ?? 'Inactif')}>
                        {client.statut}
                      </Badge>
                    </TableCell>
                    <TableCell>

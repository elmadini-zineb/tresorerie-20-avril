...
const rapprochementNav = [
  ...
  { name: 'Factures', href: '/rapprochement-module/factures', icon: FileText },
  ...
  { name: 'Clients', href: '/rapprochement-module/clients', icon: clientIcon },
  {
    ...
    subItems: [
      ...
      { name: 'TVA', href: '/rapprochement-module/rapports/tva' },
    ],
  },
];
...
export function SecondarySidebar() {
  ...
  return (
    <aside className="absolute left-16 top-0 z-20 h-full w-56 bg-[#111E3F] text-white overflow-y-auto border-r border-white/10 pt-16">

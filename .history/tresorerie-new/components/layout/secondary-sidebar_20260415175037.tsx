...
// Liens rapprochement TRESORIER (pages existantes seulement)
const rapprochementNav = [
  { name: 'Tableau de bord', href: '/rapprochement-module/dashboard', icon: BarChart3 },
  { name: 'Fournisseurs', href: '/rapprochement-module/fournisseurs', icon: fournisseurIcon },
  { name: 'Clients', href: '/rapprochement-module/clients', icon: clientIcon },
  { name: 'Factures reçues', href: '/rapprochement-module/factures/recues', icon: factureRecueIcon },
  { name: 'Factures émises', href: '/rapprochement-module/factures/emises', icon: factureEmiseIcon },
  { name: 'Rapprochement', href: '/rapprochement-module/rapprochement', icon: rapprochementIcon },
  {
    name: 'Rapports',
    href: '/rapprochement-module/rapports/etat-rapprochement',
    icon: FolderOpen,
    subItems: [
      { name: 'État de rapprochement', href: '/rapprochement-module/rapports/etat-rapprochement' },
      { name: 'CPC', href: '/rapprochement-module/rapports/cpc' },
      { name: 'Déclaration TVA', href: '/rapprochement-module/rapports/tva' },
    ],
  },
];
...
const treasuryNav: TreasuryNavItem[] = [
  // Define treasury navigation items here if needed
];
...
export function SecondarySidebar() {
  ...
  let navItems: TreasuryNavItem[] | typeof rapprochementNav = []
  let title = ''
  ...
  return (
    <aside className="fixed left-60 top-0 h-screen w-56 z-50 bg-[#111E3F] border-l border-white/10 text-white overflow-y-auto pt-16">

...
const clientsStats = [
  { label: 'À valider', count: 11, amount: 435543.65, href: '/rapprochement-module/factures?type=emises&status=a_valider' },
  { label: 'Non payé', count: 183, amount: 2450000, href: '/rapprochement-module/factures?type=emises&status=non_paye' },
  { label: 'En retard', count: 105, amount: 890000, href: '/rapprochement-module/factures?type=emises&status=en_retard', isAlert: true },
]

const fournisseursStats = [
  { label: 'À valider', count: 8, amount: 312450.00, href: '/rapprochement-module/factures?type=recues&status=a_valider' },
  { label: 'Non payé', count: 156, amount: 1980000, href: '/rapprochement-module/factures?type=recues&status=non_paye' },
  { label: 'En retard', count: 42, amount: 567000, href: '/rapprochement-module/factures?type=recues&status=en_retard', isAlert: true },
]

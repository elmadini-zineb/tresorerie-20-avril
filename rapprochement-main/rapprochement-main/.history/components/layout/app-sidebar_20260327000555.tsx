    ...
    return (
      ...
      >
        ...
        {typeof item.badgeCount === 'number' && (
          <span
            className={cn(
              'ml-2 min-w-[20px] rounded px-1.5 py-0.5 text-center text-[11px] font-semibold leading-none',
          ...
          tresorierBlocks.map((block, index) => (
            <div key={block.type === 'item' ? block.item.href : block.section.label}>
              ...
              {block.type === 'item' ? (
                ...
                <div>
                  <div className="px-4 pb-1 pt-3 text-[10px] font-semibold uppercase tracking-[0.1em] text-[rgba(255,255,255,0.35)]">
                    {block.section.label}
                  </div>

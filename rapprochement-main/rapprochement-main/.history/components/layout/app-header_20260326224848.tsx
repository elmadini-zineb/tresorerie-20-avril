...
export function AppHeader() {
  ...
  return (
    <header
      className={cn('fixed left-[240px] right-0 top-0 z-30 flex h-16 items-center justify-between border-b border-[#DDE3EF] bg-white px-8')}
    >
      {/* Company Name */}
      ...
      <div className="flex items-center gap-4">
        ...
        {user && (
          ...
          >
            {user.role === 'TRESORIER' ? 'TRÉSORIER' : 'ADMIN CLIENT'}
          </div>
        )}

                  ...
                  <TableBody>
                    {bankStatementData.map((row, i) => (
                      <TableRow key={i} className="border-[#DDE3EF] hover:bg-[#F4F6FB]">
                        ...
                        <TableCell>
                          <Badge className="bg-[#16A34A] text-white">RAPPROCHÉ</Badge>
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                    ...
                    <TableBody>
                      {invoiceMatchData.map((row, i) => (
                        <TableRow key={i} className="border-[#DDE3EF] hover:bg-[#F4F6FB]">
                          ...
                          <TableCell className="text-sm text-[#64748B]">{row.dateFacture}</TableCell>
                          <TableCell className="text-sm text-[#64748B]">{row.datePaiement || '—'}</TableCell>
                          <TableCell>
                            <Badge
                              className={
                    ...
                    {ecartData.map((row, i) => (
                      <TableRow key={i} className="border-[#DDE3EF]">
                        ...
                        <TableCell className="text-right font-semibold">
                          {row.nombre > 0 ? (
                            <Badge className="bg-[#DC2626] text-white">{row.nombre}</Badge>
                          ) : (

...
export default function FournisseursPage() {
  ...
  const totalPages = Math.max(1, Math.ceil(filteredFournisseurs.length / pageSize))
  const safePage = Math.min(currentPage, totalPages)
  const pageStart = (safePage - 1) * pageSize
  const paginatedFournisseurs = filteredFournisseurs.slice(pageStart, pageStart + pageSize)
          ...
          <div className="flex items-center justify-between border-t border-[#DDE3EF] px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-[#64748B]">
              ...
              <Select value={pageSize} onValueChange={setPageSize}>
                ...
                <SelectContent>
                  <SelectItem value="10" onSelect={() => { setPageSize(10); setCurrentPage(1) }}>10</SelectItem>
                  <SelectItem value="25" onSelect={() => { setPageSize(25); setCurrentPage(1) }}>25</SelectItem>
                  <SelectItem value="50" onSelect={() => { setPageSize(50); setCurrentPage(1) }}>50</SelectItem>
                </SelectContent>
              </Select>
              <span>par page</span>
            </div>
